...
<html>
    ...
    <body>
        ...
        <jsp:scriptlet>
            ...
            Usuario ivan=miGestor.newUsuario("ruben.perez@gmail.com");
            ivan.setNombre("Ruben");
            ivan.setApellidos("Perez");
            ivan.setEdad(25);
            miGestor.datosUsuarioModificados(ivan);
            
            // Recuperar 1 de ellos e imprimirlo por la consola
            Usuario ivanRecuperado=miGestor.getUsuario("ruben.perez@gmail.com");
        </jsp:scriptlet>
